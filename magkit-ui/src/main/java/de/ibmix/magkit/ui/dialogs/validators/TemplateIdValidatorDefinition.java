 ...
 * @since 2024-03-22
 */
@ValidatorType("templateIdValidator")
public class TemplateIdValidatorDefinition extends StringValuesValidatorDefinition {

    public TemplateIdValidatorDefinition() {
        super();
        setFactoryClass(TemplateIdValidatorFactory.class);
    }
}
